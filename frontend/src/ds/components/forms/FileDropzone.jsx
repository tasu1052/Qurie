...
<button type="button" onClick={onSelect} style={{height:36,padding:'0 14px',borderRadius:'var(--radius-control)',border:'none',background:'var(--accent)',color:'var(--text-inverse)',fontFamily:'var(--font-sans)',fontSize:13,fontWeight:600,cursor:'pointer',whiteSpace:'nowrap',lineHeight:1,width:'100%',boxSizing:'border-box'}}>{actionLabel}</button>
...
const failed=!!error;
return <div style={{display:'flex',alignItems:'center',gap:12,border:'1px solid '+(failed?'rgba(178,70,70,0.22)':'var(--border)'),background:failed?'var(--status-error-bg)':'var(--surface-card)',borderRadius:'var(--radius-md)',padding:'14px 16px',fontFamily:'var(--font-sans)'}}>
...
{failed
?<button type="button" onClick={onRetry} style={{height:30,padding:'0 14px',borderRadius:'var(--radius-control)',border:'1px solid var(--border-strong)',background:'var(--surface-card)',fontFamily:'var(--font-sans)',fontSize:12,color:'var(--ink)',cursor:'pointer',whiteSpace:'nowrap',lineHeight:1,flexShrink:0}}>다시 선택</button>
