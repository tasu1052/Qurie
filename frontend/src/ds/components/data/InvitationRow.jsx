...
<button type="button" onClick={onCancel} title="초대 취소" style={{border:'none',background:'transparent',color:'var(--text-muted)',cursor:'pointer',fontFamily:'var(--font-sans)',fontSize:12,padding:0}}>취소</button>
</>}
</div>;
}
