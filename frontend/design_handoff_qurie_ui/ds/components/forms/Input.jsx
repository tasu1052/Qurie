...
export function Input({type='text',placeholder='',value,onChange,shortcut=null,icon=null,disabled=false,width=260,style={}}){
...
<input type={type} placeholder={placeholder} value={value} onChange={onChange} disabled={disabled} onFocus={()=>setFocus(true)} onBlur={()=>setFocus(false)} style={{border:'none',outline:'none',background:'transparent',flex:1,minWidth:0,fontFamily:'var(--font-sans)',fontSize:14,color:'var(--ink)'}}/>
