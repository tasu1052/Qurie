...
<span style={{width:38,height:38,borderRadius:'50%',background:'var(--status-error-bg)',display:'inline-flex',alignItems:'center',justifyContent:'center',flexShrink:0,color:'var(--status-error)'}}>✕</span>
